...
/**
 * ═══════════════════════════════════════════════════════════════════════
 * IMPORTADOR SICOP v14.2 - DETECCIÓN INTELIGENTE POR CONTENIDO
 * ═══════════════════════════════════════════════════════════════════════
 *
 * CORRECCIÓN v14.2:
...
class ImportadorSICOPv14_2 {
    ...
    public function importarDetalleCartelesNuevo($archivo) {
        ...
        $this->addLog("📦 IMPORTANDO: DETALLE DE CARTELES v14.2", 'title');
        $this->addLog("", 'separator');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['archivo'])) {
    ...
    echo "<!DOCTYPE html><html lang='es'><head><meta charset='UTF-8'><title>Importación SICOP v14.2</title>";
    echo "<style>
    ...
    echo "<div class='header'><h1>🚀 Importación SICOP v14.2</h1><p class='version'>Detección Inteligente por Contenido</p></div>";
...
<head>
    <meta charset="UTF-8">
    <title>Importador SICOP v14.2</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🚀 SICOP v14.2</h1>
            <p class="version">Detección Inteligente por Contenido</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="highlight">
                <h4>✅ Novedades en v14.2</h4>
                <ul>
                    <li><strong>Detección inteligente:</strong> Identifica líneas por contenido</li>
                    <li><strong>Sin límite de columnas:</strong> Funciona con 8 o 15 columnas</li>
                    <li><strong>Manejo de notación científica:</strong> Códigos como 7,81E+15</li>
                    <li><strong>Búsqueda por SICOP:</strong> Enlaza partidas correctamente</li>
                </ul>
            </div>
        </div>
    </div>
