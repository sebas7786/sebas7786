            ...
            if (!isset($_POST['correo']) || !isset($_POST['contrasena'])) {
                ...
                if (!filter_var($correo, FILTER_VALIDATE_EMAIL)) {
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("SELECT id, nombre, correo, contrasena, es_admin, activo, estado_pago FROM usuarios WHERE correo = ? LIMIT 1");
                        $stmt->execute([$correo]);
                        ...
                        if ($stmt->rowCount() == 1) {
                            ...
                            if ($password_valid) {
                                ...
                                // Verificar si es admin O si está activo
                                if ($user['es_admin'] == 1 || $user['activo'] == 1) {
                                    ...
                                    $error = "Su cuenta ha sido desactivada por falta de pago. Por favor, contacte al administrador para reactivarla.";
                                    record_failed_attempt_local($user_ip, $correo);
                                    error_log("Intento de login con cuenta desactivada por falta de pago: $correo desde IP $user_ip");
                                }
                            } else {
    ...
    <div class="login-container">
        ...
        <div class="login-body">
            ...
            <div class="security-badge">
                <strong>Conexión segura</strong> - Datos protegidos con encriptación
            </div>
        </div>
    </div>
