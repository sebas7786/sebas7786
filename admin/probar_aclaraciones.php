...
try {
    ...
    if ($check->rowCount() === 0) {
        ...
        echo 'Ejecuta primero: <a href="importador_aclaraciones.php?archivo=Aclaraciones.csv">Importador de Aclaraciones</a>';
        echo '</div>';
        exit;
    }
...
try {
    ...
    if ($stats['total_aclaraciones'] == 0) {
        ...
        echo 'Ejecuta: <a href="importador_aclaraciones.php?archivo=Aclaraciones.csv">Importador de Aclaraciones</a>';
        echo '</div>';
        exit;
    }
...
<div style="background: white; padding: 15px; border-radius: 8px; margin-top: 30px; border-left: 4px solid #28a745;">
    ...
    <small style="color: #666;">
        ...
        <code>../user/licitacion_detalle.php?id=[ID]</code>
    </small>
</div>
