...
<body>
    <div class="container">
        ...
        <?php else: ?>
            ...
            <div class="section">
                <h2>📍 Distribución por Provincia (Top 10)</h2>
                <table>
                    <thead>
                        <tr>
                            <th>Provincia</th>
                            <th style="text-align: right;">Total Instituciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;"><?php echo number_format($prov['total']); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <!-- INSTITUCIONES RECIENTES -->
            <?php if (!empty($instituciones_recientes)): ?>
            <div class="section">
                <h2>🕒 Instituciones Importadas Recientemente (últimas 20)</h2>
                <table>
                    <thead>
                        <tr>
                            <th>Cédula</th>
                    ...
                    <tbody>
                        <?php foreach ($instituciones_recientes as $inst): ?>
                        <tr>
            ...
            <div style="text-align: center;">
                <a href="importador_instituciones.php" class="btn">📁 Ir al Importador</a>
            </div>
